 ...
 * who assumes the page exists — `cart`, `checkout`, `search`, `settings`,
 * `sign-in`, `/c/:slug` and three marketing pages were all removed on exactly
 * that ground. Add an entry when the page does.
 *
...
export const routes = {
  ...
  // Conversations
  /** Pass `prompt` to open the composer with it already filled in. */
